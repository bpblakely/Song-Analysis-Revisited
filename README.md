...
This project won the award for best design (equivalent to 2nd place) at the 2020 BGSU Hackathon. I'd like to thank my [teammates](https://i.imgur.com/tSbtIeO.png), David Ash and Jackson Conrad, for their contributions to this project. Since this project had an unsuccessful application of topological data analysis in this project, I will clone this respiratory and continue working on it as my schedule allows it. If I get good results I will write a paper for publication, as this field still needs some development. 
